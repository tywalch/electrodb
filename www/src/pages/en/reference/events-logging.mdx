...
*As a [Execution Option](/en/core-concepts/execution-options):*
```typescript
const logger = (event: ElectroEvent) => {
    console.log(JSON.stringify(event, null, 4));
}
...
*As a [Execution Option](/en/core-concepts/executing-queries):*

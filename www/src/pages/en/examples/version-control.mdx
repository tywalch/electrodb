...
Note that this can only be performed by an existing reviewer on the pull request — the `where` condition asserts the reviewer exists, and `returnOnConditionCheckFailure` reports whether the approval was applied

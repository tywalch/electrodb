...
<LiveExample name="patch-store-location-set" />
...
<LiveExample name="patch-store-location-remove" />
...
<LiveExample name="patch-store-location-add" />
...
<LiveExample name="patch-store-location-subtract" />
...
<LiveExample name="patch-store-location-append" />
...
<LiveExample name="patch-store-location-delete" />
...
<LiveExample name="patch-store-location-data" />
...
<LiveExample name="patch-map-property" />
...
<LiveExample name="patch-list-element-remove" />
...
<LiveExample name="patch-complex-nested-set" />
...
<LiveExample name="patch-organization-composite" />
...
<LiveExample name="patch-update-composite-edgecase" />

...
When scanning for rows, you can use filters the same as you would any query. For more information on filters, see the [Filters](/latest/queries/filters) section.

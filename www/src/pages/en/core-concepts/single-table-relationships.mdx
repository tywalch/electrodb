...
By default, and assuming you use ElectroDB's [default indexing mechanisms](/latest/modeling/indexes#composite-attribute-arrays), ElectroDB will ensure proper isolation occurs between entities located within the same table. ElectroDB accomplishes this by including your `service`, `entity`, and `version` properties from your [schema model](/latest/modeling/schema#model) on your entity's index keys.

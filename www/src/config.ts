...
export const SIDEBAR: Sidebar = {
  en: {
    ...
    Examples: [
      ...
      {
        text: "Shopping Mall directory",
        link: "en/examples/shopping-mall-directory",
      },
    ...
    Recipes: [
      {
        text: "Creating calculated attributes",
        link: "en/recipes/calculated-attribute",
      },
      {
        text: "Creating virtual attributes",
        link: "en/recipes/virtual-attribute",
      },
      {
        text: "Adding meta timestamps",
        link: "en/recipes/created-at-updated-at",
      },
      { text: "Using opaque types", link: "en/recipes/opaque-types" },
      {
        text: "Using ElectroDB with an Existing Dataset",
        link: "en/recipes/use-electrodb-with-existing-table",
      },
      {

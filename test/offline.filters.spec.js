...
describe("Filter", () => {
  it("Should allow for a filter to return an empty string with Match method", () => {
    ...
    expect(params).to.deep.equal({
      ...
      ExpressionAttributeValues: {
        ":id0": "abc",
        ":pk": "$mallstoredirectory_1$mallstores#id_abc",
      },
  ...
  describe("Clause Building", () => {
    ...
    it("Should build a clause", () => {
      ...
      let state = clause(MallStores, new ChainState(), {
        lowRent,
        beginning,
        end,
        location,
      ...
      expect(filterExpression.getExpression()).to.equal(

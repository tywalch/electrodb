...
for (const [clientVersion, client] of [
    ...
    describe("Entity", () => {
      ...
      describe("Simple crud", () => {
        ...
        it("Should return null when item retrieved does not exist", async () => {
          let data = await MallStores.get({
            sector: "does_not_exist",
            id: "also_does_not_exist",
          })
            .go()
            .then((res) => res.data);
        ...
        it("Should pass back the original dynamodb error when originalErr is set to true", async () => {
          ...
          let [electroSuccess, electroErr] = await MallStores.get({
            sector,
            id,
          })
          ...
          let [originalSuccess, originalErr] = await MallStores.get({
            sector,
            id,
          })
      ...
      describe("Tailing labels", () => {
        ...
        it("Should update 'empty' composite sort keys when a GSI Partition Key is updated", async () => {
          ...
          const updateParamsWithSparseSK = entity
            .update({ section, isle })
            .set({ name })
            .params();
          const queryParamsWithSparseSK = entity.query
            .location({ name })
            .params();
          ...
          expect(updateParamsWithSparseSK).to.deep.equal({
            UpdateExpression:
              "SET #name = :name_u0, #gsi1pk = :gsi1pk_u0, #gsi1sk = :gsi1sk_u0, #section = :section_u0, #isle = :isle_u0, #__edb_e__ = :__edb_e___u0, #__edb_v__ = :__edb_v___u0",
          ...
          await entity
            ...
            .go()
            .then((res) => res.data);
          const queryRecordWithSparseSK = await entity.query
            .location({ name })
            .go()
            .then((res) => res.data);
          ...
          await entity
            ...
            .go()
            .then((res) => res.data);
          const queryRecordWithSK = await entity.query
            .location({ name })
            .go()
            .then((res) => res.data);
        ...
        it("Should not update sort keys when a GSI Partition Key is updated on an index without an sk", async () => {
          ...
          expect(updateParamsWithSparseSK).to.deep.equal({
            UpdateExpression:
              "SET #name = :name_u0, #partition_key_idx2 = :partition_key_idx2_u0, #section = :section_u0, #isle = :isle_u0, #__edb_e__ = :__edb_e___u0, #__edb_v__ = :__edb_v___u0",
            ExpressionAttributeNames: {
              "#name": "name",
      ...
      describe("Custom index fields", async () => {
        it("Should use the index field names as theyre specified on the model", async () => {
          ...
          let MallStores = new Entity(schema, {
            client,
            table: "electro_customkeys",
          });
          let id = uuid();
          let mall = "defg";
          let stores = 1;
          let value = "ahssfh";
          await MallStores.get({ id, mall, stores })
            .go()
            .then((res) => res.data);
          await MallStores.delete({ id, mall, stores })
            .go()
            .then((res) => res.data);
          await MallStores.update({ id, mall, stores })
            .set({ value })
            .go()
            .then((res) => res.data);
          await MallStores.patch({ id, mall, stores })
            .set({ value })
            .go()
            .then((res) => res.data);
          await MallStores.create({ id: id + 1, mall, stores, value })
            .go()
            .then((res) => res.data);
          await MallStores.put({ id, mall, stores, value })
            .go()
            .then((res) => res.data);
          await MallStores.query
            .store({ id, mall, stores })
            .go()
            .then((res) => res.data);
          await MallStores.query
            .other({ id, mall, stores })
            .go()
            .then((res) => res.data);
      ...
      describe("Watchers", () => {
        ...
        describe("Readme examples", async () => {
          it("Should test Attribute Watching 'Example 1' from the readme", async () => {
            ...
            let output2 = {
              service,
              price: input2.price,
              fee: input2.price * 0.2,
            };

            let putRecord = await entity
              .put(input1)
              .go()
              .then((res) => res.data);
            let getRecord1 = await entity
              .get({ service })
              .go()
              .then((res) => res.data);
            await entity
          ...
          it("Should test Attribute Watching 'Example 3' from the readme", async () => {
            ...
            let queryRecord1 = await entity.query
              ...
              .where(({ descriptionSearch }, { contains }) =>
                contains(descriptionSearch, "mixed case"),
              )
              .go()
              .then((res) => res.data);
          ...
          it("Should test Attribute Watching 'Example 4' from the readme", async () => {
            ...
            await entity
              .update({ accountNumber, transactionId })
            ...
            let queryRecord2 = await entity.query
              .transactions({ accountNumber, transactionId })
              .go()
              .then((res) => res.data);
          ...
          it("Should be able to use watch property to bypass readOnly", async () => {
            ...
            let updateParams = entity
              ...
              .set({ description })
              .params();
            expect(updatedAtCount).to.equal(
              1,
              "updatedAt was not called the expected amount",
            );
            expect(updateParams).to.deep.equal({
              UpdateExpression:
                "SET #description = :description_u0, #updatedAt = :updatedAt_u0, #accountNumber = :accountNumber_u0, #transactionId = :transactionId_u0, #__edb_e__ = :__edb_e___u0, #__edb_v__ = :__edb_v___u0",
              ExpressionAttributeNames: {
            ...
            const readOnlyUpdate = () =>
              entity
                ...
                .params();
            expect(readOnlyUpdate).to.throw(
              `Attribute "updatedAt" is Read-Only and cannot be updated`,
            );
            const [success, result] = await entity
              .update({ accountNumber, transactionId })
              .set({ updatedAt: Date.now() })
              .go()
              .then((res) => res.data)
            ...
            expect(result.message).to.equal(
              `Attribute "updatedAt" is Read-Only and cannot be updated - For more detail on this error reference: https://electrodb.dev/en/reference/errors/#invalid-attribute`,
            );
          });
        });
        describe("Setter Triggers", () => {
          ...
          it("Should trigger the setter of a watcher because the attribute being watched is supplied regardless if the watcher was supplied after the attribute's setter has been applied", () => {
            ...
            expect(updateParams).to.deep.equal({
              UpdateExpression:
                "SET #prop3 = :prop3_u0, #prop4 = :prop4_u0, #prop1 = :prop1_u0, #prop2 = :prop2_u0, #__edb_e__ = :__edb_e___u0, #__edb_v__ = :__edb_v___u0",
              ExpressionAttributeNames: {
                "#prop1": "prop1",
                "#prop2": "prop2",
                "#prop3": "prop3",
          ...
          it("Should not trigger either setter if neither attribute is supplied", () => {
            ...
            expect(updateParams).to.deep.equal({
              UpdateExpression:
                "SET #prop6 = :prop6_u0, #prop1 = :prop1_u0, #prop2 = :prop2_u0, #__edb_e__ = :__edb_e___u0, #__edb_v__ = :__edb_v___u0",
              ExpressionAttributeNames: {
                "#prop6": "prop6",
                "#prop1": "prop1",
                "#prop2": "prop2",
          ...
          it("Should still trigger setter if the attribute is set manually and include it's value, but will do so after the attribute it's watching", () => {
            ...
            counter.start(keys.create);
            let createParams = entity
              .create({ prop1, prop2, prop6, prop4 })
              .params();
            counter.start(keys.update);
            let updateParams = entity
              .update({ prop1, prop2 })
            ...
            expect(updateParams).to.deep.equal({
              UpdateExpression:
                "SET #prop6 = :prop6_u0, #prop4 = :prop4_u0, #prop1 = :prop1_u0, #prop2 = :prop2_u0, #__edb_e__ = :__edb_e___u0, #__edb_v__ = :__edb_v___u0",
              ExpressionAttributeNames: {
                "#prop6": "prop6",
                "#prop4": "prop4",
                "#prop1": "prop1",
              ...
              ExpressionAttributeValues: {
                ":prop6_u0": "prop6_fromsetter",
                ":prop4_u0": "prop4_fromvaluefromsetter",
                ":prop2_u0": "prop2",
                ":prop1_u0": prop1,
                ":__edb_e___u0": entityName,
                ":__edb_v___u0": "1",
        ...
        describe("Getter Triggers", () => {
          ...
          it("Should trigger the setter of a watcher because the attribute being watched is supplied regardless if the watcher was supplied after the attribute's setter has been applied", async () => {
            ...
            let e1 = await service.entities.entity1
              .put({ prop1, prop2, prop3 })
              .go()
              .then((res) => res.data);
            let e2 = await service.entities.entity2
              .put({ prop1, prop2, prop3 })
              .go()
              .then((res) => res.data);
            counter.start("get1");
            let get1 = await service.entities.entity1
              .get({ prop1, prop2 })
              .go()
              .then((res) => res.data);
            counter.start("get2");
            let get2 = await service.entities.entity2
              .get({ prop1, prop2 })
              .go()
              .then((res) => res.data);
            counter.start("query1");
            let query1 = await entity1.query
              .record({ prop1 })
              .go()
              .then((res) => res.data);
            counter.start("query2");
            let query2 = await entity2.query
              .record({ prop1 })
              .go()
              .then((res) => res.data);
            counter.start("collection");
            let collection = await service.collections
              .collection2({ prop3 })
              .go()
              .then((res) => res.data);
            counter.stop();
        ...
        it("Should not allow a watcher to watch an unknown property", () => {
          ...
          expect(() => new Entity(schema)).to.throw(
            `Attribute Validation Error. The following attributes are defined to "watch" invalid/unknown attributes: "prop3"->"unknown". - For more detail on this error reference: https://electrodb.dev/en/reference/errors/#invalid-attribute-watch-definition`,
          );
        });
      });
        ...
        it("Should not allow the table PKs or SKs to be updated", async () => {
          try {
            ...
            expect(err.message).to.equal(
              `Attribute "prop2" is Read-Only and cannot be updated - For more detail on this error reference: https://electrodb.dev/en/reference/errors/#invalid-attribute`,
            );
          }
        });
      ...
      describe("Template and composite attribute arrays", () => {
        it("Should resolve composite attribute labels at an index level", async () => {
          ...
          let unitParams = MallStores.query
            .units({ mall, building, unit })
            .params();
          let leasesParams = MallStores.query
            .leases({ mall, leaseEnd, store })
            .params();
          let shopParams = MallStores.query
            .shops({ mall, building, store })
            .params();
          ...
          let createRecord = await MallStores.create({
            sector,
            store,
            mall,
            rent,
          ...
          let unitRecord = await MallStores.query
            .units({ mall, building, unit })
            .go()
            .then((res) => res.data);
          let leasesRecord = await MallStores.query
            .leases({ mall, leaseEnd, store })
            .go()
            .then((res) => res.data);
          let shopRecord = await MallStores.query
            .shops({ mall, building, store })
            .go()
            .then((res) => res.data);
          expect(unitRecord.find((record) => record.id === id)).to.not.be
            .undefined;
          expect(leasesRecord.find((record) => record.id === id)).to.not.be
            .undefined;
          expect(shopRecord.find((record) => record.id === id)).to.not.be
            .undefined;
        });
      });
      ...
      describe("Numeric and boolean keys", () => {
        it("Should create keys with primitive types other than strings if specified as a template without prefix", async () => {
          ...
          let putRecord = await entity
            .put({ number1: 55, number2: 66 })
            .go()
            .then((res) => res.data);
          let getRecord = await entity
            .get({ number1: 55, number2: 66 })
            .go()
            .then((res) => res.data);
          let updateRecord = await entity
            .update({ number1: 55, number2: 66 })
            .set({ number3: 77 })
            .go()
            .then((res) => res.data);
          let queryRecord = await entity.query
            .record({ number1: 55 })
            .go()
            .then((res) => res.data);
          let deleteRecord = await entity
            .delete({ number1: 55, number2: 66 })
            .go()
            .then((res) => res.data);
          expect(putRecord).to.deep.equal({ number1: 55, number2: 66 });
          expect(getRecord).to.deep.equal({ number1: 55, number2: 66 });
          expect(queryRecord).to.deep.equal([
            { number1: 55, number2: 66, number3: 77 },
          ]);
          expect(updateRecord).to.deep.equal({
            number1: 55,
            number2: 66,

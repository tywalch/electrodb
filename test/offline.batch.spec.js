...
describe("BatchWrite", () => {
  describe("batchPut", () => {
    ...
    it("Should return unprocessed items and only their attributes by default", () => {
          ...
          electro: [
            {
              PutRequest: {
                Item: {
                  ...
                  gsi3sk:
                    "$test_entity#category_food/coffee#building_buildingz#unit_g1#store_lattelarrys",
                  gsi4pk: "$bugbeater_1#store_lattelarrys",
                  gsi4sk:
                    "$test_entity#mall_washingtonsquare#building_buildingz#unit_g1",
                  __edb_e__: "TEST_ENTITY",
                  __edb_v__: "1",
                },
              },
      ...
      let res = MallStores.formatBulkWriteResponse(UnprocessedPut, {});
      expect(res.unprocessed).to.deep.equal([records[0]]);
    });
  });
  ...
  describe("batchDelete", () => {
    ...
    it("Should return unprocessed items and their composite attributes by default batch delete", () => {
      ...
      let res = MallStores.formatBulkWriteResponse(UnprocessedDelete, {});
      expect(res.unprocessed).to.deep.equal([
        {
          id: "abc",
          sector: "a1",
        },
  ...
  it("Should separate batch get records into batches with a max size of 100 (per dynamodb spec)", () => {
    ...
    expect(params[0].RequestItems.electro.Keys)
      .to.be.an("array")
      .with.length(100);
    ...
    expect(params[1].RequestItems.electro.Keys)
      .to.be.an("array")
      .with.length(100);
    ...
    expect(params[2].RequestItems.electro.Keys)
      .to.be.an("array")
      .with.length(1);

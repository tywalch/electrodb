...
describe("Model Validation", () => {
	...
	it("should allow composite attributes to be used more than once in one index if the number of attributes in the sk equal one", () => {
		...
		const update = Users.update({ id: 'abc' }).set({ name: 'stephanie' }).params();
		const deleted = Users.delete({ id: 'abc' }).params();
		const get = Users.get({ id: 'abc' }).params();
		const query = Users.query.byAccount({ id: 'abc' }).params();
		const queryBegins = Users.query.byAccount({ id: 'abc' }).begins({}).params();
		const queryBetween = Users.query.byAccount({ id: 'abc' }).between({}, {}).params();
		...
		expect({
			...
			"update": {
				"UpdateExpression": "SET #name = :name_u0, #id = :id_u0, #__edb_e__ = :__edb_e___u0, #__edb_v__ = :__edb_v___u0",
				"ExpressionAttributeNames": {
					"#name": "name",
					"#id": "id",
					"#__edb_e__": "__edb_e__",
	...
	it("should allow composite attributes to be used more than once in one index if the number of attributes in the sk equal one and pk attributes is greater than one", () => {
		...
		const update = Users.update({ id: 'abc', accountId: 'acct1' }).set({ name: 'stephanie' }).params();
		const deleted = Users.delete({ id: 'abc', accountId: 'acct1' }).params();
		const get = Users.get({ id: 'abc', accountId: 'acct1' }).params();
		const query = Users.query.byAccount({ id: 'abc', accountId: 'acct1' }).params();
		const queryBegins = Users.query.byAccount({ id: 'abc', accountId: 'acct1' }).begins({}).params();
		const queryBetween = Users.query.byAccount({ id: 'abc', accountId: 'acct1' }).between({}, {}).params();
		const queryGte = Users.query.byAccount({ id: 'abc', accountId: 'acct1' }).gte({}).params();
		const queryGt = Users.query.byAccount({ id: 'abc', accountId: 'acct1' }).gt({}).params();
		const queryLte = Users.query.byAccount({ id: 'abc', accountId: 'acct1' }).lte({}).params();
		const queryLt = Users.query.byAccount({ id: 'abc', accountId: 'acct1' }).lt({}).params();
		...
		expect({
			...
			"update": {
				"UpdateExpression": "SET #name = :name_u0, #accountId = :accountId_u0, #id = :id_u0, #__edb_e__ = :__edb_e___u0, #__edb_v__ = :__edb_v___u0",
				"ExpressionAttributeNames": {
					"#name": "name",
					"#accountId": "accountId",
					"#id": "id",

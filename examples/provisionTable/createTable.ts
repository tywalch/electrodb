import DynamoDB, { LocalSecondaryIndex, GlobalSecondaryIndex, CreateTableInput, ScalarAttributeType, KeySchema, GlobalSecondaryIndexList, LocalSecondaryIndexList, AttributeDefinitions } from "aws-sdk/clients/dynamodb";
...
export function makeCreateTableInput(options: MakeCreateTableInputOptions): CreateTableInput {
    const {
        tableName,
        tableIndex,
        secondaryIndexes,
    } = getTableDetails(options);

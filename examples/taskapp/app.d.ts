export declare namespace employeesEntity {
    ...
    type coworkersIndexPK = { office: string }

    type coworkersIndexSK = { team: teamEnum } | { team: teamEnum, title: string } | { team: teamEnum, title: string, employee: string }

    type teamsIndex = { team: teamEnum } | { team: teamEnum, dateHired: string } | { team: teamEnum, dateHired: string, title: string }

    type teamsIndexPK = { team: teamEnum }

    type teamsIndexSK = { dateHired: string } | { dateHired: string, title: string }

    type employeeLookupIndex = { employee: string }

    type employeeLookupIndexPK = { employee: string }

    type employeeLookupIndexSK = {}

    type rolesIndex = { title: string } | { title: string, salary: string }

    type rolesIndexPK = { title: string }

    type rolesIndexSK = { salary: string }

    type directReportsIndex = { manager: string } | { manager: string, team: teamEnum } | { manager: string, team: teamEnum, office: string }

    type directReportsIndexPK = { manager: string }

    type directReportsIndexSK = { team: teamEnum } | { team: teamEnum, office: string }
...
export declare namespace tasksEntity {
    ...
    type projectIndexPK = { project: string }

    type projectIndexSK = { employee: string } | { employee: string, status: statusEnum }

    type assignedIndex = { employee: string } | { employee: string, project: string } | { employee: string, project: string, status: statusEnum }

    type assignedIndexPK = { employee: string }

    type assignedIndexSK = { project: string } | { project: string, status: statusEnum }

    type statusesIndex = { status: statusEnum } | { status: statusEnum, project: string } | { status: statusEnum, project: string, employee: string }

    type statusesIndexPK = { status: statusEnum }

    type statusesIndexSK = { project: string } | { project: string, employee: string }
...
export declare namespace officesEntity {
    ...
    type officeIndexPK = { office: string }

...
export function uniqueItems<T extends Record<string, any>>(arr: T[], ...uniqueIdentifers: Array<keyof T>): T[]
export function uniqueItems<T>(arr: T[]): T[]
export function uniqueItems<T>(arr: T[], ...uniqueIdentifiers: Array<keyof T>): T[] {
